...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Donation> $donations
     * @property-read int|null $donations_count
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereLastname($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereBirthday($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereSex($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereJob($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Doner newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Doner newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Doner query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
